...
<body>
	...
	<div class="input-group">
		<label style="font-weight: bold;">Recherche par:<br>*Groupe Sanguin<br>*Organes  </label>
		<input type="text" name="dID3" >

	</div>

	<div class="input-group">
		<button type="submit" name="SearchD" class="btnA" style="padding: 5px;margin-left: 90px;margin-top: 20px; padding-left: 15px; padding-right: 15px">Recherche</button>
	</div>
