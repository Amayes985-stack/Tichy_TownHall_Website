...
<body>
	...
	<table class="table4">
	   ...
	   <h1 style="margin-left:37% ;margin-top:70px"   class="asd"> Confirmer son Email </h1>
    ...
    <div classs="xa" style="margin-top:0px">
        ...
        <label for="subject" style="margin:10px ;display: inline-block;">Sujet</label>
        <input type="text"  id="subject" name="subject" maxlength="50" style="width:400px;" placeholder="Confirmation Rendez-vous">
        ...
        <button type="submit"  id="message" name="sendemail" style="width:200px;height:30px;border-radius: 10px; background: #992828 ;margin-left:45%;color: white ">Envoyer
               </button>
