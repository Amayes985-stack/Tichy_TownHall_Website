...
<header>
	<h1 >APC<span>Tichy</span></h1>
		...
		<ul >
			...
			<li><a href="add.php">Ajouter Description</a></li>
...
<form method="post" action="add.php" class="add">
	...
	<div class="input-group">
		<button type="submit" name="SearchPA" class="btn">Recherche</button>
	</div>
...
<div class="input-group">
	...
	<div class="input-group-add">
	 ...
	 <div class="input-group">
			<button type="submit" name="AddD" class="btn">Ajouter</button>
			</div>
