...
<div class="contentP" style="font-weight: bold;">
	...
	<label>ID: <?php echo "" .isset($_SESSION['UserID']);?></label>
	 	   ...
	 	   <label> Email : <?php echo $col['Email']; ?></label>
	 	   	 	   <br>
	 	   <br>
	 	   <label> Nom : <?php echo $col['Name']; ?></label>
	 	   	 	   <br>
	 	   <br>
	 	   <label> Adresse : <?php echo $col['Address']; ?></label>
	 	   	 	   <br>
	 	   <br>
	 	   <label> Numéro_Téléphone : <?php echo $col['ContactNumber']; ?></label>
	 	   	 	   <br>
	 	   <br>
	 	   <label> Groupe_Sanguin : <?php echo $col['Bloodtype']; ?></label>
	 	   	 	   <br>
	 	   <br>
	...
	<div class="input-group">
		<button type="submit" name="feedback" class="btn" style=" border-radius: 5px;margin-left: 80%; border:none;padding: 10px 30px 10px 30px">Envoyer un Feedback</button>
	</div>
