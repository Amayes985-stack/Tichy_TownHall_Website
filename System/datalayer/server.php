...
//Conception du serveur spécial pour le bon déroulement des évènements 
session_start();  //ouberture de session 
$errors=array();  //initialisation du compteur des erreurs à 0

$mysqli = new mysqli("localhost","root","","registration");  //connexion à la base de donnée 
...
//lorsque mon pointeur tombe sur la ligne register 
if (isset($_POST['Register'])) {
	...
	$UserID 	= $mysqli -> real_escape_string($_POST['UserID']);   //affectation des valeurs 
...
//Insertion si tout est correct et qu'aucune erreur est détectée 
...
if (empty($adminpassword)) {
	...
	$_SESSION['AdminID']=$adminID;
  	...
  	header('location:../presentaionlayer/admin/index3.php'); 
		...
		array_push($errors,"The ID/Password not correct"); //je me sers du tableau des erreurs en indiquant comme quoi y'a une erreur à partir d'un tableau 
...
$sqlfeed = "INSERT INTO  feedback (pID,feedback) VALUES ('$userprofile','$feedback2') ";
  ...
  //toujours fermer sa base donnée avant de quitter (réflexe) 
 $mysqli -> close();
