        ...
        <div class="col-lg-4 col-md-4 col-12">
          <div class="card">
               <img class="card-img-top" src="Images/Biomètrie.jpg" alt="Card image">
                  <div class="card-body">
                    <h4 class="card-title" >Assemblée & Direction Régionale</h4>
          ...
          <div class="card">
               <img class="card-img-top" src="Images/Urbanisme.jpg" alt="Card image">
                  <div class="card-body">
                    ...
                    <p class="card-text">Liste des Villages de Tichy </p>
                    <a href="villages.php" class="btn btn-primary">En Savoir Plus </a>
                 </div>
           </div>
        </div>
