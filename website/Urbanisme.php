...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <section class="my-5">
      <div class ="py-5">
         <h2 class="text-center">Documents à Fournir : Urbanisme </h2>
      </div>

      <div class ="container-fluid">
         <div class = "row" >
            <div class ="col-lg-6 col-md-6 col-12">
                <img src ="Images/possession.jpg" class ="img-fluid aboutimg">
            </div>
            <div class ="col-lg-6 col-md-6 col-12">
                <h2 class ="display-5">Dossier à fournir pour un Certificat de Possession </h2>
                <p class="py-0"> 04 Plans de Masse  et de Situation.</p>
                <p class="py-0"> Déclaration sur  L’honneur à retirer auprès du Service Technique, à remplir en 04 Exemplaires.</p>
                <p class="py-0"> 02 Extraits de Naissance.</p>
                <p class="py-0"> 01 Photocopie de la Carte  d’Identité.</p>
                <p class="py-0"> 04 Enveloppes Grand Format.</p>
                <p class="py-0"> 04 Chemises Cartonnées.</p>
                <p class="py-0">Après deux Mois 1580,00 DA pour les frais d’enregistrement.</p>
...
<section class="py-5">
        <div class ="container-fluid">
           <div class = "row" >
              <div class ="col-lg-6 col-md-6 col-12">
                  <img src ="Images/rural.jpg" class ="img-fluid aboutimg">
              </div>
              <div class ="col-lg-4 col-md-6 col-12">
                  <h2 class ="display-5">Dossier à fournir pour une aide à l'Habitat Rural  </h2>
                  <h2 class ="display-5"> Nouvelle Construction :  </h5>
                  <p class="py-0"> 05 Imprimés à remplir, à retirer auprès du Sce Technique. </p>
                  <p class="py-0">01 Extrait de Naissance de L’Intéressé. </p>
                  <p class="py-0"> 01 Extrait de Naissance du conjoint.</p>
                  <p class="py-0"> 01 Fiche Familiale ou Fiche Individuelle.</p>
                  <p class="py-0"> 01 Non Activité du Conjoint (s’il travaille, sa fiche de paye).</p>
                  <p class="py-0"> 01 Fiche  de Paye de L’Intéressé.</p>
                  <p class="py-0"> 01 Certificat  de Possession.</p>
  ...
  <section class="py-5">
    <div class ="container-fluid">
       <div class = "row" >
          <div class ="col-lg-6 col-md-6 col-12">
              <img src ="Images/amenagement.jpg" class ="img-fluid aboutimg">
          </div>
          <div class ="col-lg-4 col-md-6 col-12">
      <h2 class ="display-5"> Aménagement & Extension :  </h5>
              <p class="py-0"> 05 Imprimés à remplir, à retirer auprès du Sce Technique. </p>
              <p class="py-0">01 Extrait de Naissance de L’Intéressé. </p>
              <p class="py-0"> 01 Extrait de Naissance du conjoint.</p>
              <p class="py-0"> 01 Fiche Familiale ou Fiche Individuelle.</p>
              ...
              <p class="py-0"> 01 Fiche  de Paye de L’Intéressé.</p>
              <p class="py-0"> 01 Certificat  de Possession.</p>
              <p class="py-0"> 01 Exemplaire du permis de construire.</p>
  ...
  <section class="py-5">
    <div class ="container-fluid">
       <div class = "row" >
          <div class ="col-lg-6 col-md-6 col-12">
              <img src ="Images/morcellement.png" class ="img-fluid aboutimg">
          </div>
          <div class ="col-lg-4 col-md-6 col-12">
              <h2 class ="display-5"> Dossier A Fournir  Pour Un  Morcellement   </h5>Dossier A Fournir  Pour Un  Morcellement :
              <p class="py-0"> 05 Demandes de Morcellement, Fournis Par L’Architecte. </p>
              <p class="py-0"> 05 Exemplaires du Certificat de Possession Légalisés. </p>
              <p class="py-0"> 05 Plans De Masse  Et De Situation.</p>
              <p class="py-0"> 05 Plans d'équipement. </p>
              <p class="py-0"> 05 Plans De Morcellement.</p>
              <p class="py-0"> 05 Enveloppes Grand Format.</p>
              <p class="py-0"> 05 Chemises Cartonnées.</p>
  ...
  <section class="py-5">
    <div class ="container-fluid">
       <div class = "row" >
          <div class ="col-lg-6 col-md-6 col-12">
              <img src ="Images/lotir.jpg" class ="img-fluid aboutimg">
          </div>
          <div class ="col-lg-4 col-md-6 col-12">
              <h2 class ="display-5"> Dossier A Fournir Pour Un Permis de Lotir    </h5>Dossier A Fournir  Pour Un  Morcellement :
              <p class="py-0"> 05 Demandes de Morcellement, Fournis Par L’Architecte. </p>
              <p class="py-0"> 05 Exemplaires du Certificat de Possession Légalisés. </p>
              <p class="py-0"> 05 Plans De Masse  Et De Situation.</p>
              <p class="py-0"> 05 Plans d'équipement. </p>
              <p class="py-0"> 05 Plans De Morcellement.</p>
              <p class="py-0"> Le Coefficient D’Occupation Du Sol.</p>
              <p class="py-0"> Le Coefficient D’Emprise Au Sol.</p>
              <p class="py-0"> 04 Enveloppes Grand Format.</p>
              <p class="py-0"> 04 Chemises Cartonnées.</p>
  ...
  <li id="menu-item-186" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-186"><a href="about.php">Les Projets de l'APC</a></li>
