...
<span>2éme Arrêt de Bus</span>
<span>Tichy 06023, Béjaia, Algérie</span></div>
                        <div class="tel"><span>034 81 52 65 / 034 81 52 66 </span></div>
                        <div class="horaires"><span>Horaires d'ouverture :</span><br>
<span>Dimanche, Lundi, Mardi,  mercredi, jeudi de 8h30 à 12h et de 13h00 à 16h00</span>
<span>Service de Biomètrie ouvert le Dimanche, Lundi, Mardi, Mercredi, Jeudi de 08h30 à 15h00 </span>
</div>
                    </div>

                    <div class="sidebar-widget ">
                        <div id="nav_menu-2" class="widget_nav_menu"><ul id="menu-menu_mentions" class="menu"><li id="menu-item-5274" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5274"><a href="https://www.facebook.com/CompteofficielcellulecomunicationAPCTichy">Cellule de Communication </a></li>
...
<li id="menu-item-186" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-186"><a href="about.php">À propos de l'APC</a></li>
...
<li id="menu-item-5289" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5289"><a href="/travailler/demandeurs-demploi/la-mairie-recrute/">L'APC recrute</a></li>
<li id="menu-item-187" class="home menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2 current_page_item menu-item-187"><a href="https://www.epinay-sur-seine.fr/" aria-current="page">Page d’accueil</a></li>
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
  ...
  <section class="my-5">
      <div class ="py-5">
         <h2 class="text-center">Liste des élus</h2>
      </div>
      ...
      <div class ="container-fluid">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-12">
            <div class="card">
                 <img class="card-img-top" src="Images/Maire.jpg" alt="Card image">
                    <div class="card-body">
                      <h4 class="card-title">Mr.Khouface Nassim </h4>
                      <p class="card-text">Maire de l'APC / Président de l'APC</p>
