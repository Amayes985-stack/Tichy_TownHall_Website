...
<section class="my-5">
    ...
    <div class ="container-fluid">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-12">
          <div class="card">
               <img class="card-img-top" src="Images/Biomètrie.jpg" alt="Card image">
                  <div class="card-body">
                    <h4 class="card-title">Documents Biomètriques </h4>
                    <p class="card-text">Passeport, Carte d'Identité, Permis de conduite</p>
                    <a href="Urbanisme.php" class="btn btn-primary">Cliquez Ici </a>
                 </div>
           </div>
        </div>
        ...
        <div class="col-lg-4 col-md-4 col-12">
          <div class="card">
               <img class="card-img-top" src="Images/Urbanisme.jpg" alt="Card image">
                  <div class="card-body">
                    <h4 class="card-title">Acte de Naissance </h4>
                    <p class="card-text"> </p>
                    <a href="https://www.interieur.gov.dz/index.php/fr/mes-d%C3%A9marches-administratives/etat-civil.html" class="btn btn-primary">En Savoir Plus </a>
                 </div>
           </div>
        </div>
        ...
        <div class="col-lg-4 col-md-4 col-12">
          <div class="card">
               <img class="card-img-top" src="Images/appointement.png" alt="Card image">
                  <div class="card-body">
